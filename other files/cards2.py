...
class Player:
	...
	# def split(self):
	# 	if self.table.hand.cards[0].rank == self.table.hand.cards[1].rank:
	# 		if not self.table.hand.is_split:
	# 			self.table.splitHand = Hand(self.table.hand.cards[1], self.table.deck.pop())
	# 			self.table.hand = Hand(self.table.hand.cards[0], self.table.deck.pop())

	# 			print("Your hand: ",self.table.hand)
	# 		else:
	...
	def _win(self):
		...
		# if self.table.splitHand:
		# 	self.table.hand = self.table.splitHand
		# 	self.table.splitHand = None	
		# 	print("Your hand: ",self.table.hand)
		self.deckCheck()
